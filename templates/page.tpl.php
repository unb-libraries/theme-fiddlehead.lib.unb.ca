...
<?php endif; ?>
<!-- /#admin-shortcuts -->
<div id="top-nav" class="navbar-fixed-top admin-shortcuts clearfix">
  ...
  <div class="container">
    <div class="navbar">
      ...
      <div class="navbar-inner">
        ...
        <?php endif; ?>
        <?php if ($main_menu): ?>
        <button aria-label="Navigation menu" class="btn btn-navbar collapsed" data-toggle="collapse" data-target=".nav-collapse"> <span class="hide">Menu</span> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </button>
...
<?php if ($is_front): ?>
  <div id="featurebar" class="container">
    <div class="row">
      <div class="span9">
        <?php print render($page['feature_left']); ?>
      </div>
      <div class="span3">
        <?php print render($page['feature_right']); ?>
      </div>
    </div>
  </div>
<?php endif ?>
...
<div id="footer-bottom" class="clearfix site-footer-bottom" role="contentinfo">
  <div class="container">
    <div id="footer-bottom-content" class="row-fluid footer-bottom-content"> <?php print render($page['footer_bottom']); ?> </div>
  </div>
</div>
<!-- /#footer -->
<?php endif; ?>
